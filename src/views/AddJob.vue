    ...
    <div class="container m-auto max-w-2xl py-24">
      <div class="bg-white px-6 py-8 mb-4 shadow-xl rounded-md border m-4 md:m-0">
        <form @submit.prevent="handelsubmit">
          <h2 class="text-3xl text-center font-semibold mb-6 text-blue-950">Add Job</h2>
          ...
          <h3 class="text-xl font-bold mt-6 mb-4">Company Info</h3>
          <div class="mb-4">
            <label class="block text-blue-950 font-bold mb-2">Company Name</label>
            <input type="text" v-model="form.company.name" class="border rounded w-full py-2 px-3 mb-2" placeholder="Company Name" required />
          </div>
          <div class="mb-4">
            <label class="block text-blue-950 font-bold mb-2">Company Description</label>
          ...
          <div class="mb-4">
            <label class="block text-blue-950 font-bold mb-2">Contact Email</label>
          ...
          <div class="mb-4">
            <label class="block text-blue-950 font-bold mb-2">Contact Phone</label>
