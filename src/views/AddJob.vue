    ...
    <div class="container m-auto max-w-2xl py-24">
      <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
        <form @submit.prevent="handelsubmit">
          ...
          <button type="submit" class="bg-black hover:bg-white text-white hover:text-black font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline border-2 border-black transition-all duration-300">
            Add Job
          </button>
        </form>
      </div>
