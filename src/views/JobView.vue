      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          <div class="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
            ...
            <div class="text-gray-600 mb-4 flex align-middle justify-center md:justify-start">
              <i class="pi pi-map-marker text-xl text-black mr-2"></i>
              <p class="text-black">{{ state.job.location }}</p>
            </div>
          </div>

          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            <h3 class="text-black text-lg font-bold mb-6">Job Description</h3>
            <p class="mb-4">{{ state.job.description }}</p>
            <h3 class="text-black text-lg font-bold mb-2">Salary</h3>
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <RouterLink :to="`/jobs/edit/${state.job.id}`" class="bg-black hover:bg-white text-white hover:text-black text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block border-2 border-black transition-all duration-300">
              Edit Job
            </RouterLink>
